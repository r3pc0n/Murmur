...
class SettingsAPI:
    ...
    def get_config(self) -> dict:
        ...
        return {
            ...
            "CLOUD_GROQ_MODEL":       config.CLOUD_GROQ_MODEL,
            "CLOUD_DEEPGRAM_MODEL":   config.CLOUD_DEEPGRAM_MODEL,
            "CLOUD_CARTESIA_MODEL":   config.CLOUD_CARTESIA_MODEL,
            "CLOUD_VOXTRAL_API_KEY":  config.CLOUD_VOXTRAL_API_KEY,
            "CLOUD_GROQ_API_KEY":     config.CLOUD_GROQ_API_KEY,
            "CLOUD_DEEPGRAM_API_KEY": config.CLOUD_DEEPGRAM_API_KEY,
            "CLOUD_CARTESIA_API_KEY": config.CLOUD_CARTESIA_API_KEY,
            "AI_CLEANUP_ENABLED":     config.AI_CLEANUP_ENABLED,
            "CLEANUP_PROVIDER":       config.CLEANUP_PROVIDER,
            "OPENROUTER_API_KEY":     config.OPENROUTER_API_KEY,
            "OPENROUTER_MODEL":       config.OPENROUTER_MODEL,
            "LOCAL_CLEANUP_MODEL":    config.LOCAL_CLEANUP_MODEL,
            "LOCAL_CLEANUP_BASE_URL": config.LOCAL_CLEANUP_BASE_URL,
